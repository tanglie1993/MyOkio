...
//        assertEquals(0, in.skip(1)); // Try to skip when exhausted.
    ...
    @Test public void hexStringWithManyLeadingZeros() throws IOException {
        ...
        assertLongHexString(repeat('0', Segment.SIZE + 1) + "1", 0x1);
    }
...
//    }
    ...
    @Test public void decimalStringWithManyLeadingZeros() throws IOException {
        ...
        assertLongDecimalString(repeat('0', Segment.SIZE + 1) + "1", 1);
    }
    ...
    @Test
    public void selectSpanningMultipleSegments() throws IOException {
    ...
    @Test
    public void selectNotFound() throws IOException {
        Options options = Options.of(
                ByteString.encodeUtf8("ROCK"),
                ByteString.encodeUtf8("SCISSORS"),
                ByteString.encodeUtf8("PAPER"));
    ...
    @Test
    public void selectValuesHaveCommonPrefix() throws IOException {
        Options options = Options.of(
    ...
    @Test
    public void selectLongerThanSource() throws IOException {
        Options options = Options.of(
                ByteString.encodeUtf8("abcd"),
                ByteString.encodeUtf8("abce"),
                ByteString.encodeUtf8("abcc"));
    ...
    @Test
    public void selectReturnsFirstByteStringThatMatches() throws IOException {
        Options options = Options.of(
                ByteString.encodeUtf8("abcd"),
    ...
    @Test
    public void selectNoByteStrings() throws IOException {
        Options options = Options.of();
        sink.writeUtf8("abc");
        assertEquals(-1, source.select(options));
    }
    ...
    @Test
    public void selectFromEmptySource() throws IOException {
        Options options = Options.of(
                ByteString.encodeUtf8("abc"),
    ...
    @Test
    public void selectNoByteStringsFromEmptySource() throws IOException {
        Options options = Options.of();
        assertEquals(-1, source.select(options));
    }

    @Test
    public void selectEmptyByteString() throws IOException {
