...
//
    ...
    public void writeStringUtf8() throws IOException {
        ...
        sink.flush();
        ByteString expected = ByteString.decodeHex("74c999cb8872616ec999cb8c73c3b472");
        ByteString actual = data.readByteString();
...
//
    ...
    @Test
    public void writeUtf8SubstringWithCharset() throws IOException {
