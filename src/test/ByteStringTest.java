    ...
    Factory ONE_BYTE_PER_SEGMENT = new Factory() {
      ...
      private ByteString makeSegments(ByteString source) {
        ...
        for (int i = 0; i < source.getData().length; i++) {
          ...
          segment.data[segment.front] = source.getByte(i);
          segment.rear++;
        }
        return buffer.snapshot();
      }
...
//
//  @Test
//  public void toStringOnShortText() {
...
//
//  @Test
//  public void toStringOnLongTextIsTruncated() {
...
//
//  @Test
//  public void toStringOnTextWithNewlines() {
...
//
//  @Test
//  public void toStringOnLongDataIsTruncated() {
//    ByteString byteString = factory.decodeHex(""
//        + "60b420bb3851d9d47acb933dbe70399bf6c92da33af01d4fb770e98c0325f41d3ebaf8986da712c82bcd4d55"
