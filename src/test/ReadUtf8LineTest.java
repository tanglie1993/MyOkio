...
public final class ReadUtf8LineTest {
  ...
  @Test
  public void readUtf8LineStrictWithLimits() throws IOException {
  ...
  @Test
  public void readUtf8LineStrictNoBytesConsumedOnFailure() throws IOException {
    data.writeUtf8("abc\n");
    try {
  ...
  @Test
  public void readUtf8LineStrictEmptyString() throws IOException {
    data.writeUtf8("\r\nabc");
  ...
  @Test
  public void readUtf8LineStrictNonPositive() throws IOException {
    data.writeUtf8("\r\n");
    try {
  ...
  @Test
  public void newlineAtEnd() throws IOException {
    data.writeUtf8("abc\n");
    assertEquals("abc", source.readUtf8LineStrict(3));
